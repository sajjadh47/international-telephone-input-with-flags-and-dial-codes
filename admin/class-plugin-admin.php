...
class International_Telephone_Input_With_Flags_And_Dial_Codes_Admin
{
	...
	public function enqueue_styles()
	{
		...
		if ( $current_scrn->id !== 'settings_page_international-telephone-input-with-flags-and-dial-codes' ) return;
	...
	public function enqueue_scripts()
	{
		...
		wp_localize_script( $this->plugin_name, 'INTERNATIONAL_TELEPHONE_INPUT_WITH_FLAGS_AND_DIAL_CODES', array(
			...
			'select_country_txt_i18n'	=> __( "Please Select a Country/Countries...", 'international-telephone-input-with-flags-and-dial-codes' ),
		) );
	}
	...
	{
		$links[] = sprintf( '<a href="%s">%s</a>', admin_url( 'options-general.php?page=international-telephone-input-with-flags-and-dial-codes' ), __( 'Settings', 'international-telephone-input-with-flags-and-dial-codes' ) );
