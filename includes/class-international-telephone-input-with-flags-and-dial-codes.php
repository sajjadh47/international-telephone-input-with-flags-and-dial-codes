<?php
/**
 * This file contains the definition of the International_Telephone_Input_With_Flags_And_Dial_Codes class, which
...
class International_Telephone_Input_With_Flags_And_Dial_Codes {
	...
	public function __construct() {
		$this->version     = defined( 'INTERNATIONAL_TELEPHONE_INPUT_WITH_FLAGS_AND_DIAL_CODES_PLUGIN_VERSION' ) ? INTERNATIONAL_TELEPHONE_INPUT_WITH_FLAGS_AND_DIAL_CODES_PLUGIN_VERSION : '1.0.0';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once INTERNATIONAL_TELEPHONE_INPUT_WITH_FLAGS_AND_DIAL_CODES_PLUGIN_PATH . 'includes/class-international-telephone-input-with-flags-and-dial-codes-loader.php';
		 ...
		 */
		require_once INTERNATIONAL_TELEPHONE_INPUT_WITH_FLAGS_AND_DIAL_CODES_PLUGIN_PATH . 'admin/class-international-telephone-input-with-flags-and-dial-codes-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once INTERNATIONAL_TELEPHONE_INPUT_WITH_FLAGS_AND_DIAL_CODES_PLUGIN_PATH . 'public/class-international-telephone-input-with-flags-and-dial-codes-public.php';
